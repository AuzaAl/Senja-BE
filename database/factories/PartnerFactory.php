...
class PartnerFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'slug' => Str::slug($name),
            'number' => null,
            'category' => $this->faker->randomElement(['Display', 'Collaboration', 'Network']),
            'logo' => null,
            'hero_image' => null,
            'description' => $this->faker->paragraph(2),
            'capabilities' => ['Professional displays', 'AV systems'],
            'relationship' => $this->faker->sentence(8),
            'relationship_detail' => $this->faker->paragraph(2),
